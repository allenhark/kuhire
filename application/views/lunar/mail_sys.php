			...
			<div class="span7">
				...
				<?php if($sys->num_rows () == 0):?>
					<div class="alert-information">
						<p>
							It seems Max has nothing for you yet. Which is <i class="splashy-smiley_happy"></i>. You can have 
							<i class="wpzoom-drink-2"></i> and some <i class="wpzoom-food"></i> meanwhile.
					</div>
				<?php else:?>
