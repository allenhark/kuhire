...
<div class="span12">
	<ul class="unstyled">
		...
		<li class="span5">
		<form action="<?=base_url('landing/alternative');?>" method="post">
           ...
           <a href="<?=base_url('landing/join');?>" class="btn btn-inverse"><i class="splashy-group_green_add"></i> Alternative? </a>
            <hr>
            <p>You can customize your profile later. Already registered? <i class="splashy-arrow_medium_right"></i><b>
            	<a href="<?=base_url('landing/login');?>"> Login </a></b></p>
...
<li class="span5">
		...
		<p> 
			...
			<a href="http://blog.scrobber.com" target="_blank"><i class="icomoon-icon-wordpress"></i> Blog <i class="icomoon-icon-redo "></i></a>

		</p>

		<p>
			 <a href="<?=base_url('landing/contact');?>" <i class="icomoon-icon-support "></i> Contact us </a>
		</p> 
