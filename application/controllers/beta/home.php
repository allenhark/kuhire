...
class Home extends CI_Controller {
    ...
    public function index() {
        ...
        $data['main'] = 'main';
        $data['title'] = 'Scrobber - Discover a new way to social renting and hiring';
        $data['keywords'] = 'Scrobber, Social hiring, social renting';
        $data['description'] = 'Scrobber a new way to rent and hire out from your friends';
    ...
    function contact_us() {
        if (isset($_POST['name'])):
            ...
            $data['title'] = 'Contact Scrobber - Discover a new way to social renting and hiring';
            $data['keywords'] = 'Scrobber, Social hiring, social renting';
            $data['description'] = 'Scrobber a new way to rent and hire out from your friends';
    ...
    function pricing() {
        $data['main'] = 'pricing';
        $data['title'] = 'Pricing Plans Scrobber - Discover a new way to social renting and hiring';
        $data['keywords'] = 'Scrobber, Social hiring, social renting';
        $data['description'] = 'Scrobber a new way to rent and hire out from your friends';
    ...
    function goodbye() {
        ...
        $data['title'] = 'Scrobber - Discover a new way to social renting and hiring';
        $data['keywords'] = 'Scrobber, Social hiring, social renting, Antony Gitonga,';
        $data['description'] = 'Scrobber a new way to rent and hire out from your friends';
        $data['categories'] = $this->data->get_categories();
    ...
    function guide() {
        $data['main'] = 'guide';
        $data['title'] = 'Scrobber Guide - Discover a new way to social renting and hiring';
        $data['keywords'] = 'Scrobber, Social hiring, social renting, Antony Gitonga,';
        $data['description'] = 'Scrobber a new way to rent and hire out from your friends';
        $data['categories'] = $this->data->get_categories();
    ...
    private function wanted_category_view() {
        ...
        $data['title'] = 'browse ' . $c->cat_name . ' category | Scrobber';

        $data['keywords'] = 'view people looking for rentals in ' . $c->cat_name . ' category | Scrobber';
    ...
    private function wanted_front_page() {
        $data['main'] = 'wanted';
        $data['title'] = 'Wanted Items | Scrobber';
        $data['keywords'] = '';
        $data['description'] = '';
    ...
    private function wanted_view_item() {
        ...
        $data['title'] = $d->want_name . ' | Wanted Items Scrobber';
        $data['keywords'] = '';
        $data['description'] = '';
        $data['latest'] = $this->data->wanted_latest();
        $this->load->view('beta/loader', $data);
    ...
    private function wanted_search() {
        ...
        $data['title'] = $_GET['s'] . ' | Wanted Items Scrobber';
        $data['keywords'] = '';
        $data['description'] = '';
        $data['latest'] = $this->data->wanted_latest();
        $this->load->view('beta/loader', $data);
    ...
    public function legal() {
        if (!$this->uri->segment(2)):
            $data['main'] = 'legal';
            $data['title'] = 'Scrobber and You | Scrobber ';
            $data['keywords'] = '';
            $data['description'] = '';
            $this->load->view('beta/loader', $data);
        else:
    ...
    public function add() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (isset($_GET['src']) | isset($_POST['edit'])):
                $data['title'] = 'Edit item | Scrobber';
            else:
                $data['title'] = 'Add new item | Scrobber';
            endif;
    ...
    public function steps() {
        ...
        $data['main'] = 'steps';
        $data['title'] = 'Complete your Item | Scrobber beta';
        $data['keywords'] = '';
        $data['description'] = '';
        $this->load->view('beta/loader', $data);
    }
    ...
    public function send() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $subject = 'New Message on Scrobber';

            $msg = 'Hi, ' . $_POST['user_name'] . '
                          <br>
                          <p>
                            You have recieved a new message on Scrobber from ' . $_POST['name'] . '
                                Login into your account to view this message.
                                <a href=' . base_url('lunar/?redirect_to=inbox') . '> Login </a> 
                                    alternativly, paste this link on your browser to access Scrobber
    ...
    public function join() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data['keywords'] = 'Join Scrobber, Register for Scrobber, Hire Scrobber, Scrobber Kenya';
            $data['description'] = 'Join Scrobber Kenya';
            $data['iasoc'] = 'join';
    ...
    public function temp_login() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data['title'] = 'Fast Login | Scrobber ';
            $data['keywords'] = '';
            $data['description'] = '';
            $data['iasoc'] = 'temp';
            $this->load->view('beta/loader', $data);
    ...
    public function suggest_wanted() {
        ...
        $data['title'] = 'Potential clients for your item | Scrobber ';
    ...
    public function owner() {
        ...
        if ($this->form_validation->run() == FALSE) {
            $data['main'] = 'owner';
            $data['title'] = 'Quick Contact | Scrobber ';
            $data['keywords'] = '';
            $data['description'] = '';
    ...
    public function forgot() {
        if (isset($_GET['hash'])):
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $data['main'] = 'forgot';
                $data['title'] = 'Change Password | Scrobber ';
                $data['keywords'] = '';
                $data['description'] = '';
            ...
            if ($this->form_validation->run() == FALSE) {
                $data['main'] = 'forgot';
                $data['title'] = 'Password Reminder | Scrobber ';
                $data['keywords'] = '';
                $data['description'] = '';
    ...
    public function alternative() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data['title'] = 'Alternative Registration | Scrobber';
            $data['keywords'] = '';
            $data['description'] = '';
            $this->load->view('beta/loader', $data);
        } else {
