...
class Facebook_test extends CI_Controller {
    ...
    function me() {
        ...
        if ($uf->num_rows === 1):
            ...
            if (isset($_GET['connect']) == 'true'):
                ...
                $data['title'] = 'Connect Scrobber to facebook';
                $data['keywords'] = '';
                $data['description'] = '';
    ...
    function invite() {
        ...
        $data['title'] = 'Invite friends to Scrobber';
        $data['keywords'] = '';
        $data['description'] = '';
        $data['fb_user'] = $this->fb_me;
    ...
    function message() {
        $message = "{" . $this->fb_me['id'] . "} using Scrobber, Start using Scrobber and discover a new way to social hiring!";
