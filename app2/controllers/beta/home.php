...
class Home extends CI_Controller {
    ...
    function contact_us() {
        if (isset($_POST['name'])):
            ...
            $data['keywords'] = 'Kuhire, Social hiring, s
            ocial renting';
            $data['description'] = 'Kuhire a new way to rent and hire out from your friends';
        ...
        function rent() {
            ...
            $data['main'] = 'rent';
            $data['title'] = 'Renting Policy Kuhire - Discover a new way to social renting and hiring';
            $data['keywords'] = 'Kuhire, Social hiring, social renting';
            $data['description'] = 'Kuhire a new way to rent and hire out from your friends';
    ...
    function send_contact() {
        ...
        if(isset($_POST['next'])):
            $return =base_url($_POST['next'].'?contacted=true') ;
        else:
        ...
        //echo '<pre>';
        //echo $email. $subject. $msg. $to. $return;
