	...
	<div class="span12 row-fluid clearfix">
		...
		<div class="span3 clearfix">
			...
			<ul class="unstyled">
				...
				<li><t class="btn btn-small btn-info"><i class="brocco-icon-flag"></i> Location</t> <?=$row->location;?></li>
			</ul>
		</div>

		<div class="span5 last clearfix" bgcolor="grey">
			<p><?=$row->desc;?></p>
		</div>
		<hr>
	</div>
...
<div class="span4 well lform">
	...
	<div class="row-fluid clearfix span12">
		...
		<div class="btn-group">
		<a href="<?= base_url("view/" . $ft -> item_id); ?>" class="btn btn-mini" title="View item"><i class='icon-eye-open'></i> View</a>
