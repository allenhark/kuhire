    ...
    <div class="body-text">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid shadow">
                <div class="span4">
                    <div class="qbox">
                        <h3><i class="icon-white icon-browse pull-left"></i> Categories</h3>
                        <ul class="nav nav-list">
                            <?php foreach ($this->data->get_categories_home()->result() as $cats): ?>
                                <li> <a href="<?= base_url($cats->cat_slug); ?>"> <?= $cats->cat_name; ?></a></li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                </div>
                ...
                <div class="span8" >
                    ...
                    <?php foreach ($this->data->ads()->result() as $ad): ?>
                        <div class="span12 home-d" style="background-image: url(<?= base_url('images/' . $ad->ad_image); ?>); min-height: 300px;">
                    ...
                    <div class="home-listing" />
                        <div class="span4 shadow fixed-height">
                            <img src="<?=base_url('images/venue.jpg');?>" alt="" >
                            <h5>Find the perfect venue </h5>
                            <p>
                                For party planners and event organisers.
                                <br>
                                <a href="<?=base_url('events-accessories-hire');?>"><i class="icon-hand-right"></i> Venues Hire </a>
                            </p>
                        </div>

                        <div class="span4 shadow fixed-height">
                            <img src="<?=base_url('images/bike.jpg');?>" alt="" >
                            <h5>Motor cycles</h5>
                            <p>
                                Take to the open road and Hire a motorbike
                                <br>
                                <a href="<?=base_url('vehicle-hire');?>"><i class="icon-hand-right"></i> Motorbike Hire </a>
                            </p>
                        </div>

                        <div class="span4 shadow fixed-height">
                            <img src="<?=base_url('images/cooling.jpg');?>" alt="" >
                            <h5>There are better solutions than this...</h5>
                            <p>
                                ... cool down and hire an air conditioning unit!
                                <br>
                                <a href="<?=base_url('tools');?>"><i class="icon-hand-right"></i> Air condition hire </a>
                            </p>
                        </div>
                    </div>
                                ...
                                <div class="thumbnail">
                                    <div style="background-color: white; width: 100%;">
                                        <a href="<?= base_url($listings->slug . '?ref=front+page'); ?>">
                                            <img src="<?= base_url('images/thumbnails/' . $listings->image); ?>" alt="<?= base_url($listings->name); ?> for hire" class="thumbnail displayed" style="max-height: 147px; min-height: 147px; width: auto; float: center;">
                                        </a>
                                    </div>
                                    ...
                                    <div class="caption" style="min-height: 230px;">
                                        ...
                                        <p class="price"><?php if ($listings->item_price): echo ' KShs ' . $listings->item_price;
    ...
    <?= word_limiter($listings->name, 6); ?> 
                                        ...
                                        <ul class="list-btns">
                                            <!-- li><a href="<?= base_url($listings->slug . '?ref=view+later'); ?>" id="property_1" class="add-to-list-js" 
                                                   ...
                                                   <div><a href='<?= base_url($listings->slug . "?ref=view+later"); ?>' id='property_<?= $listings->item_id; ?>'><?= $listings->name; ?></a><?php if ($listings->item_price): echo $listings->item_price . ' KSH';
    else: echo 'Price: Enquire';
    endif; ?></div>">
