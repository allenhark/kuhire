                    ...
                    <div class="nav-collapse">
                        ...
                        <form class="navbar-form pull-right" action="<?= base_url('search'); ?>" method="get" style="overflow:auto;">
                            <div class="input-append">
                                <input class="span2" id="appendedInputButton" type="text" value="<?php if(isset($_GET['keyword'])): echo $_GET['keyword']; endif;?> <?php if(isset($_GET['s'])): echo $_GET['s']; endif;?>" name="s" x-webkit-speech="x-webkit-speech" placeholder="Search here...">
