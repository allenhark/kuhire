    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="span12 contact-info">
                ...
                <a href="mailto:hi@scrobber.com" class="span1 social-network pull-left"> hi@kuhire.com</a>

                <div class="span6 social-network" align="center">
                
                    <a href="<?= base_url('about?ref=nav+bar'); ?>">ABOUT US &nbsp|</a>
                    <a href="<?= base_url('rent?ref=nav+bar'); ?>">&nbspRenting policy&nbsp|&nbsp</a>
                    <a href="<?= base_url('faq?ref=nav+bar'); ?>"> FAQS &nbsp</a>
                </div>
                <ul class="span3 social-network pull-right">
