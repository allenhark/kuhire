...
<?php
   ...
   $aFiles = array(
      ...
      'javascripts/jquery.easing.js',
      'javascripts/responsiveslides.min.js',
	  'javascripts/jquery.cookies.js',
	  'javascripts/jquery.tooltip.js',
	  'javascripts/dareslider.js',
	  'javascripts/isotope.min.js',
	  'javascripts/jquery.placeholder.min.js',
	  'javascripts/jquery.fitvids.js',
	  'javascripts/jquery.prettyPhoto.js',
	  'javascripts/jquery.flexslider-min.js',
	  'javascripts/custom.js',
	  'theme-options/theme-options.js',
	  'bootstrap.js',
	  'lib/datepicker/bootstrap-datepicker.min.js',
	  'lib/tag_handler/jquery.taghandler.min.js',
	  'js/forms/jquery.spinners.min.js',
	  'lib/uniform/jquery.uniform.min.js',
	  'lib/multiselect/js/jquery.multi-select.min.js',
	  'js/gebo_common.js'	  
